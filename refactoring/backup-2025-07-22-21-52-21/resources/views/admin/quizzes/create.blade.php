<x-layouts.admin title="Criar Quiz - HCP Admin">
    <div class="py-6 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-hcp-secondary-50 to-hcp-secondary-100 dark:from-hcp-secondary-900 dark:to-hcp-secondary-800 min-h-screen">
        <div class="max-w-4xl mx-auto">
            ...
            <div class="bg-white dark:bg-hcp-secondary-800 rounded-xl shadow-sm">
                <form method="POST" action="{{ route('admin.quizzes.store') }}" class="p-6 space-y-6">
                    @csrf
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <textarea id="description" name="description" rows="3" required
                                          class="w-full px-3 py-2 border border-hcp-secondary-300 dark:border-hcp-secondary-600 rounded-lg focus:ring-2 focus:ring-hcp-primary-500 focus:border-transparent bg-white dark:bg-hcp-secondary-700 text-hcp-secondary-900 dark:text-white"
                                          placeholder="Descreva o objetivo e conteúdo do quiz...">{{ old('description') }}</textarea>
                                @error('description')
                                    <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="md:col-span-2">
                                ...
                                <textarea id="instructions" name="instructions" rows="2"
                                          class="w-full px-3 py-2 border border-hcp-secondary-300 dark:border-hcp-secondary-600 rounded-lg focus:ring-2 focus:ring-hcp-primary-500 focus:border-transparent bg-white dark:bg-hcp-secondary-700 text-hcp-secondary-900 dark:text-white"
                                          placeholder="Instruções específicas para os participantes...">{{ old('instructions') }}</textarea>
                                @error('instructions')
                                    <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <select id="category" name="category" required
                                    ...
                                    <option value="hr" {{ old('category') === 'hr' ? 'selected' : '' }}>Recursos Humanos</option>
                                    <option value="it" {{ old('category') === 'it' ? 'selected' : '' }}>Tecnologia da Informação</option>
                                    <option value="security" {{ old('category') === 'security' ? 'selected' : '' }}>Segurança</option>
                                    <option value="processes" {{ old('category') === 'processes' ? 'selected' : '' }}>Processos</option>
                                    <option value="culture" {{ old('category') === 'culture' ? 'selected' : '' }}>Cultura Organizacional</option>
                                </select>
                                @error('category')
                                    <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                                @enderror
                            ...
                            <div>
                                ...
                                <select id="difficulty_level" name="difficulty_level" required
                                    ...
                                    <option value="basic" {{ old('difficulty_level') === 'basic' ? 'selected' : '' }}>Básico</option>
                    ...
                    <div class="border-b border-hcp-secondary-200 dark:border-hcp-secondary-700 pb-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div>
                                ...
                                <input type="number" id="passing_score" name="passing_score" value="{{ old('passing_score', 70) }}" 
                            ...
                            <div>
                                ...
                                <input type="number" id="max_attempts" name="max_attempts" value="{{ old('max_attempts', 3) }}" 
                            ...
                            <div>
                                ...
                                <input type="number" id="points_reward" name="points_reward" value="{{ old('points_reward', 100) }}" 

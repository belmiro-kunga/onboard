        ...
        <nav class="mt-6 px-3">
            <div class="space-y-2">
                ...
                <a href="{{ route('courses.index') }}" 
                   class="group flex items-center px-3 py-2 text-sm font-medium rounded-lg transition-colors duration-200 relative {{ request()->routeIs('courses.*') ? 'bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300' : 'text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700' }}">
                    <svg class="w-5 h-5 flex-shrink-0" :class="sidebarCollapsed ? 'mr-0' : 'mr-3'" fill="none" stroke="currentColor" viewBox="0 0 24 24">
